price_numerix_IO_PO = function(T=30, WAC=0.08, notional=100000, r0=0.078, k=0.6, r_bar=0.08, sigma=0.12){
  ...
  for (t in 1:N){
    ...
    sum_CF_IO= sum_CF_IO + disc[t]*IP[t+1]
    sum_CF_PO= sum_CF_PO + disc[t]*(SP[t+1]+PP[t+1])
  }
  
  return(price_IO= sum_CF_IO,price_PO= sum_CF_PO)
