price_numerix_with_oas = function(T=30, WAC=0.08, notional=100000, r0=0.078, k=0.6, r_bar=0.08, sigma=0.12,oas){
  ...
  for (i in 1:N){
    R_adj =  dt*(rowSums(short_rate[,2:(i*30)+1],dims = 1) + oas*length(short_rate[2:(i*30)+1]));
